...
# POST /api/admin/password-reset-requests/<int:request_id>/dismiss
# -> backend/routers/admin_console.py
...
# POST /api/admin/moderation/action, GET/POST /api/admin/profanity-filter
# -> backend/routers/admin_console.py
...
# MIGRATED to FastAPI: GET/POST /api/admin/settings,
# GET /api/admin/settings/public (public) -> backend/routers/admin_console.py
...
# MIGRATED to FastAPI: all GET/POST/DELETE /api/admin/discord-bot/* routes
# -> backend/routers/admin_console.py
# (the _discord_bot_* helper functions above are retained — the FastAPI router
#  calls them via gapi_gui.* at request time.)
...
# MIGRATED to FastAPI: POST /api/admin/push/broadcast -> backend/routers/admin_growth.py
...
# MIGRATED to FastAPI: POST/GET /api/admin/ab-tests, PATCH /api/admin/ab-tests/<int:experiment_id>
#   -> backend/routers/admin_growth.py
...
# MIGRATED to FastAPI: POST/GET /api/admin/user-groups, DELETE /api/admin/user-groups/<int:group_id>,
#   POST/GET /api/admin/user-groups/<int:group_id>/members,
#   DELETE /api/admin/user-groups/<int:group_id>/members/<username>
#   -> backend/routers/admin_growth.py
