...
#### Entry requirements for this section
- Classify every API-affecting change as **breaking** or **non-breaking**.
- Add migration notes for behavior/schema/API changes.
- Record deprecations with target removal release.
